...
def write_batch_header(batch_file, processname, batch_parameters, total_time):
	if(batch_parameters["BATCH_TYPE"] == "SBATCH"):
		...
		batch_file.write("#SBATCH -t "+str(total_time * 2)+":00:00\n")
		...
		batch_file.write("#PBS -l procs="+str(batch_parameters["PROCS"])+",pmem="+str(batch_parameters["PMEM"])+",walltime="+str(total_time * 2)+":00:00\n")
